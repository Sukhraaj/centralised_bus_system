	    ...
	    <div class="container d-flex align-items-center px-4">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav mr-auto">
                ...
                {
				?>
                    <li class="nav-item"><a href="admin_welcome.php" class="nav-link pl-0">Home</a></li>
                    <li class="nav-item"><a href="add_category.php" class="nav-link">Educational Institute</a></li>
                    <li class="nav-item"><a href="manage_category.php" class="nav-link">Manage Edu. Institute</a></li>
                    <li class="nav-item"><a href="view_routes_admin.php" class="nav-link">Routes</a></li>
                    <li class="nav-item"><a href="view_booking.php" class="nav-link">Bookings</a></li>
