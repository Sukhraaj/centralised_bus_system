...
<section class="hero-wrap hero-wrap-2" style="background-image: url('images/bg_1.jpg');">
    ...
    <div class="row no-gutters slider-text align-items-center justify-content-center">
        ...
        <h1 class="mb-2 bread">View Booking</h1>
        </div>
    </div>
    </div>
</section>
                ...
                <div class="col-lg-12 mx-auto wow fadeInUp table-responsive" data-wow-delay="0.1s">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                           ...
                           $query = "SELECT booking.*, routes.from_route, routes.to_route from `booking` inner join `routes` on booking.route=routes.id  and booking.booking_status='Booked'";
